...
(function() {
  var CoffeeScript, Package, async, compilers, eco, extname, fs, hogan, join, normalize, _, _ref,
  ...
  try {
    ...
    compilers.mustache = function(module, filename) {
      var content;
      content = hogan.compile(fs.readFileSync(filename, 'utf8'), {
        asString: true
      });
      return module._compile("module.exports = new Hogan.Template(" + content + ");", filename);
    };
  } catch (err) {
